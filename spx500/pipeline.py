...
def run_full_pipeline(skip_ingestion=False, models=("lr", "arima")):
    """
    Main pipeline entry point for all SPX500 intervals (1h, 1d, 1w, 1m).
    """
    if not skip_ingestion:
        print("Starting SPX500 data ingestion for all intervals...")
    ...
    print("\nFull SPX500 Pipeline execution complete.")
