...
def train_arima_model(interval="1h", p=5, d=1, q=0):
    """
    Trains an ARIMA model on USOIL Close price for a given interval.
    """
    ...
    experiment_name = f"USOIL_ARIMA_{interval}"
    ...
    with mlflow.start_run(run_name=f"ARIMA_{interval}_Model"):
        ...
        notify_mlflow_run_summary(asset_name="USOIL", model_name="ARIMA", interval=interval)
